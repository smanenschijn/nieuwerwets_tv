...
namespace UNICOPLUGIN\Inc\Post_Types;

use UNICOPLUGIN\Inc\Abstracts\Post_Type;
 ...
 *
 * @version  2.6.0
 * @package  UNICOPLUGIN/Abstracts
 * @category Abstract Class
 * @author   Wptech
 */
class Testimonials extends Post_Type {

	protected $post_type = 'unico_testimonials';
	...
	public static function init() {
		...
		self::instance()->singular  = esc_html__( 'Testimonial', 'wpunico' );
		self::instance()->plural    = esc_html__( 'Testimonials', 'wpunico' );
