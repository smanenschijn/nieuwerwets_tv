 ...
 * @since 1.0.0
 */
class Our_Benifits extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Benifits', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_benifits',
			[
				'label' => esc_html__( 'Our Benifits', 'unico' ),
			]
		);
		$this->add_control(
			'title',
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col text-center">
                        <div class="sec-heading mx-auto">
                            ...
                            <?php if(($settings['text'])): ?><p><?php echo wp_kses( $settings['text'], $allowed_tags );?></p><?php endif; ?>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="large-features-box text-center mb-4" data-aos="fade-up" data-aos-duration="1200">
                            <div class="large-features-icon-box d-table">
                                <?php the_post_thumbnail('unico_85x85', array('class' => 'img-responsive')); ?>
                            </div>
                            <h3><?php the_title();?></h3>
                            <p><?php echo wp_kses(unico_trim(get_the_content(), $settings['text_limit']), true); ?></p>
                            <a href="<?php echo ( get_post_meta(get_the_id(), 'ext_url', true )); ?>" class="tw-readmore"><?php esc_html_e('Read More', 'unico'); ?>
