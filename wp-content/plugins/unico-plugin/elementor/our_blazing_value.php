 ...
 * @since 1.0.0
 */
class Our_Blazing_Value extends Widget_Base {
	...
	public function get_name() {
		return 'unico_our_blazing_value';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Blazing Value', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_blazing_value',
			[
				'label' => esc_html__( 'Our Blazing Value', 'unico' ),
			]
		);
		$this->add_control(
			'title',
