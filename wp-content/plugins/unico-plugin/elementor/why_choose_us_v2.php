...
class Why_Choose_Us_V2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Why Choose Us V2', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'why_choose_us_v2',
			[
				'label' => esc_html__( 'Why Choose Us V2', 'unico' ),
			]
		);
		$this->add_control(
			'title',
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 p-0">
                        <div class="image-block-content bg-theme inverse-color">
                            ...
                            <p class="m-a20 f-w6"><?php echo wp_kses( $settings['text'], $allowed_tags );?> </p>
