...
class Banner_V5 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Banner V5', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'banner_v5',
			[
				'label' => esc_html__( 'Banner V5', 'unico' ),
			]
		);
		$this->add_control(
			'bg_image',
	...
	protected function render() {
        ...
        <section class="cover height-100 hero imagebg" data-overlay="6">
            ...
            <div class="bg-img-holder" style="background: url(<?php echo esc_url(wp_get_attachment_url($settings['bg_image']['id']));?>); opacity: 1;">
                <img alt="<?php esc_attr_e('Awesome Image', 'unico'); ?>" src="<?php echo esc_url(wp_get_attachment_url($settings['bg_image']['id']));?>">
            </div>
            <?php endif; ?>
