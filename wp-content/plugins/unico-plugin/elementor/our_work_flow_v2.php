 ...
 * @since 1.0.0
 */
class Our_Work_Flow_V2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Work Flow V2', 'unico' );
	}
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 mb-4">
                        <div class="features features-center style-1" data-aos="fade-down" data-aos-duration="1200">
                            <?php the_post_thumbnail('unico_150x150', array('class' => 'img-responsive')); ?>
                            <h4><?php the_title();?></h4>
