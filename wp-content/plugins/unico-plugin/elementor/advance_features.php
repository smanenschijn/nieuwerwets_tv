 ...
 * @since 1.0.0
 */
class Advance_Features extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Advance Features', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'advance_features',
			[
				'label' => esc_html__( 'Advance Features', 'unico' ),
			]
		);
		$this->add_control(
			'title',
			[
				...
				'default'     => __( 'Advance Features', 'unico' ),
			]
		);
		$this->add_control(
			'text',
		...
		$this->add_control(
              'services', 
			  	[
            		...
            		'default' => 
						[
                			['title1' => esc_html__('Digital Marketing', 'unico')],
                			['title1' => esc_html__('Contant Marketing', 'unico')],
							['title1' => esc_html__('Powerful Design', 'unico')],
							['title1' => esc_html__('Data Analysis', 'unico')],
            			],
            		'fields' => 
						[
                			[
