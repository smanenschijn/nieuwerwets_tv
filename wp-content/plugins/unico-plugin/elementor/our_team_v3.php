...
class Our_Team_V3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Team V3', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_team_v3',
			[
				'label' => esc_html__( 'Our Team V3', 'unico' ),
			]
		);
		$this->add_control(
			'title',
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 mb-4">
                        <div class="our-team team-vert">
                            ...
                            <div class="rt-content-box">
                                ...
                                <span class="simple-designation"><?php echo (get_post_meta( get_the_id(), 'designation', true ));?></span>
                                <?php
