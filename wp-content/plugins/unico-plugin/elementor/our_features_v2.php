...
class Our_Features_V2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Features V2', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_features_v2',
			[
				'label' => esc_html__( 'Our Features V2', 'unico' ),
			]
		);
		$this->add_control(
			'title',
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="veticle-features">
                            <div class="veticle-features-item">
                                <div class="veticle-large-features-box"><i class="<?php echo (str_replace( "icon ",  "", get_post_meta(get_the_id(), 'service_icon', true ))); ?>"></i></div>
