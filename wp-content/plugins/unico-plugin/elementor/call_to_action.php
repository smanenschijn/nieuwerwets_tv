...
class Call_To_Action extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Call To Action', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'call_to_action',
			[
				'label' => esc_html__( 'Call To Action', 'unico' ),
			]
		);
		$this->add_control(
			'bg_image',
	...
	protected function render() {
        ...
        <!-- ============================ Join Us Call to Action Start ================================== -->
        <section class="image-bg-wrap" <?php if($settings['bg_image']['id']): ?>style="background:url(<?php echo esc_url(wp_get_attachment_url($settings['bg_image']['id']));?>) no-repeat;"<?php endif; ?>>
            <div class="container">
                <div class="row">
