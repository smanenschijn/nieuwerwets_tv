 ...
 * @since 1.0.0
 */
class Why_People_Love extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Why People Love', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'why_people_love',
			[
				'label' => esc_html__( 'Why People Love', 'unico' ),
			]
		);
		$this->add_control(
			'feature_image',
            ...
            <div class="container-fluid p-0">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 p-0">
                        <div class="image-block-content bg-warning inverse-color">
                            ...
                            <div class="light-vid mt-4">
                                <a href="<?php echo esc_url( $settings['video_link']['url'] );?>" class="btn-trans-video pl-0 lightbox-image"><i class="ti-control-play"></i><?php echo wp_kses( $settings['video_title'], $allowed_tags );?></a>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
