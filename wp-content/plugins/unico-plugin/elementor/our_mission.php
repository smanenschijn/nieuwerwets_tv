...
class Our_Mission extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Mission', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_mission',
			[
				'label' => esc_html__( 'Our Mission', 'unico' ),
			]
		);
		$this->add_control(
			'subtitle',
                    ...
                    <div class="col-lg-8 col-md-7 col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <div class="veticle-features" data-aos="fade-left" data-aos-duration="1200">
                                    <div class="veticle-features-item">
                                        <div class="veticle-large-features-box"><i class="<?php echo esc_attr(str_replace( "icon ",  "", $item['icons']));?>"></i></div>
