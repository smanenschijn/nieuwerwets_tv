 ...
 * @since 1.0.0
 */
class Related_Services extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Related Services', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'related_services',
			[
				'label' => esc_html__( 'Related Services', 'unico' ),
			]
		);
		$this->add_control(
			'title',
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="large-features-2" data-aos="fade-up" data-aos-duration="1200">
                            <div class="large-features-2-item">
                                <div class="large-features-2-icon"><?php the_post_thumbnail('unico_60x60', array('class' => 'img-responsive')); ?></div>
