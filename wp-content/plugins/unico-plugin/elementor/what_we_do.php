 ...
 * @since 1.0.0
 */
class What_We_Do extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'What We Do', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'what_we_do',
			[
				'label' => esc_html__( 'What We Do', 'unico' ),
			]
		);
		$this->add_control(
			'title',
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 mb-4">
                        <div class="features-thumb-box">
                            <?php the_post_thumbnail('unico_360x210', array('class' => 'img-responsive')); ?>
                            <div class="large-features-box-content">
                                <div class="features-content">
                                    <h3><?php the_title(); ?></h3>
                                    <p><?php echo wp_kses(unico_trim(get_the_content(), $settings['text_limit']), true); ?></p>
                                </div>
                                <a href="<?php echo (get_post_meta( get_the_id(), 'ext_url', true ));?>" class="tw-readmore">
