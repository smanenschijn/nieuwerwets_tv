 ...
 * @since 1.0.0
 */
class Why_Choose_Services extends Widget_Base {
	...
	public function get_name() {
		return 'unico_why_choose_services';
	}
	...
	public function get_title() {
		return esc_html__( 'Why Choose Services', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'why_choose_services',
			[
				'label' => esc_html__( 'Why Choose Services', 'unico' ),
			]
		);
		$this->add_control(
			'title',
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="large-features-box style-2 text-center mb-4" data-aos="fade-down" data-aos-duration="1200">
                            <div class="large-features-icon-box d-table">
                                <?php the_post_thumbnail('unico_100x100', array('class' => 'img-responsive')); ?>
                            </div>
                            <h3><?php the_title();?></h3>
