...
class Our_Features_V3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Features V3', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_features_v3',
			[
				'label' => esc_html__( 'Our Features V3', 'unico' ),
			]
		);
		$this->add_control(
			'title',
                    ...
                    <div class="col-lg-6 col-md-6 mb-4">
                        <div class="large-features-2 style-1">
                            <div class="large-features-2-thumb">
                                <?php the_post_thumbnail('unico_90x90', array('class' => 'img-responsive')); ?>
                            </div>
                            <div class="large-features-2-detail">
                                <h4 class="font-2"><?php the_title();?></h4>
