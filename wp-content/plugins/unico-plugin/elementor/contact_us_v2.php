...
class Contact_Us_V2 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Contact Us V2', 'unico' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'contact_us_v2',
            [
                'label' => esc_html__( 'Contact Us V2', 'unico' ),
            ]
        );
		$this->add_control(
              'info', 
			  	[
            		...
            		'default' => 
						[
                			['title' => esc_html__('Head Offices', 'unico')],
							['title' => esc_html__('Drop a Mail', 'unico')],
							['title' => esc_html__('Call Us', 'unico')],
            			],
            		'fields' => 
						[
                			[
		...
		$this->add_control(
			'contact_form_v2',
			[
				'label'       => __( 'Contact Form 7 Ur', 'unico' ),
				'type'        => Controls_Manager::TEXTAREA,
				'dynamic'     => [
					'active' => true,
				],
            ...
            <div class="container">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-5 col-md-5">
                    	<div class="image-bg ct-img m-r40" style="background:url(<?php echo esc_url(wp_get_attachment_url($settings['feature_image']['id']));?>) no-repeat center center;"></div>
                    </div>
                    <?php endif; ?>   
                    <div class="col-lg-7 col-md-7">
                        <div class="contact-form">
                            <?php echo do_shortcode($settings[contact_form_v2])?>
                        </div>
                    </div>
