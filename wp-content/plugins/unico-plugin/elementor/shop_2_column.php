 ...
 * @since 1.0.0
 */
class Shop_2_Column extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Shop 2 Column', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'shop_2_column',
			[
				'label' => esc_html__( 'Shop 2 Column', 'unico' ),
			]
		);
		$this->add_control(
			'title',
                                ...
                                <div class="product-caption-info">
                                    ...
                                    <div class="product-caption-thumb">
                                        <div class="product-caption-content">
                                        	<a href="<?php echo esc_url( the_permalink( get_the_id() ) );?>"><?php the_post_thumbnail('unico_350x350', array('class' =>'img-fluid mx-auto')); ?></a>
                                        </div>
                                    </div>
