...
class Services_V1 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Services V1', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'services_v1',
			[
				'label' => esc_html__( 'Services V1', 'unico' ),
			]
		);
		$this->add_control(
			'title',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'See More Services', 'unico' ),
			]
		);
		$this->add_control(
			'btn_link',
                    ...
                    <div class="col-lg-4 col-md-4 mb-4">
                        <div class="middle-icon-features">
                            <div class="middle-icon-features-item">
                                <div class="middle-icon-large-features-box"><i class="<?php echo (str_replace( "icon ",  "", get_post_meta(get_the_id(), 'service_icon', true ))); ?>"></i></div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <?php $count = 1; while ( $query->have_posts() ) : $query->the_post();
						...
						if($count == 1 or $count == 4 or $count == 7){
							$class = 'f-light-warning';
						}
						else if($count == 3 or $count == 6 or $count == 8){
							$class = 'f-light-success';
						}
						else
							$class = '';
					?>
                    <div class="col-lg-4 col-md-4 mb-4">
                        <div class="middle-icon-features" data-aos="fade-up" data-aos-duration="1200">
                            <div class="middle-icon-features-item">
                                <div class="middle-icon-large-features-box <?php echo esc_attr($class); ?>"><i class="<?php echo (str_replace( "icon ",  "", get_post_meta(get_the_id(), 'service_icon', true ))); ?>"></i></div>
                                <div class="middle-icon-features-content">
                                    <h4><?php the_title();?></h4>
                                    <p><?php echo wp_kses(unico_trim(get_the_content(), $settings['text_limit']), true); ?></p>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 text-center">
                        <a class="btn btn-primary btn-lg btn-rounded" href="<?php echo esc_url( $settings['btn_link']['url'] );?>"><?php echo wp_kses( $settings['btn_title'], true );?><i class="ml-2 ti-arrow-right"></i></a>
                    </div>
                </div>
                <?php endif; ?>
            </div>
