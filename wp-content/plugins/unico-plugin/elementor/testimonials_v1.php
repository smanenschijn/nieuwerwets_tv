...
class Testimonials_v1 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Testimonials V1', 'unico' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'testimonials_v1',
            [
                'label' => esc_html__( 'Testimonials V1', 'unico' ),
            ]
        );
        $this->add_control(
            'title',
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="testimonial-wrap <?php if($count == 2) echo 'active';?>" data-aos="fade-up" data-aos-duration="1200">
                            ...
                            <div class="client-thumb-box">
                                <div class="client-thumb-content">
                                    ...
                                    <span class="small-font"><?php echo (get_post_meta( get_the_id(), 'test_designation', true ));?></span>
                                </div>
                            </div>
                        </div>
                    </div>
