 ...
 * @since 1.0.0
 */
class Our_Partnership extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Partnership', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_partnership',
			[
				'label' => esc_html__( 'Our Partnership', 'unico' ),
			]
		);
		$this->add_control(
			'feature_image',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Join Our Team', 'unico' ),
			]
		);
		$this->add_control(
			'btn_link',
            ...
            <div class="container-fluid p-0">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 p-0">
                        <div class="image-block-content bg-theme">
                            <div class="pt-5 pb-5 inverse-color">
                                <h1><?php echo wp_kses( $settings['title'], $allowed_tags );?></h1>
                                <p class="lead-i"><?php echo wp_kses( $settings['text'], $allowed_tags );?></p>
                                <?php if($settings['btn_link']['url']): ?><a href="<?php echo esc_url( $settings['btn_link']['url'] );?>" class="btn btn-lg btn-over-light btn-rounded"><?php echo wp_kses( $settings['btn_title'], $allowed_tags );?></a><?php endif; ?>
                            </div>
                        </div>
                    </div>
                </div>
