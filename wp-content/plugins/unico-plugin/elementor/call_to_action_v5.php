 ...
 * @since 1.0.0
 */
class Call_To_Action_V5 extends Widget_Base {
	...
	public function get_name() {
		return 'unico_call_to_action_v5';
	}
	...
	public function get_title() {
		return esc_html__( 'Call To Action V5', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'call_to_action_v5',
			[
				'label' => esc_html__( 'Call To Action V5', 'unico' ),
			]
		);
		$this->add_control(
			'bg_image',
            ...
            <div class="container pos-vertical-center">
                <div class="row">
                    <div class="col-md-8 col-lg-8">
                        <h1 class="mb-3 font-2 font-normal">
                        ...
                        <a class="btn btn-primary border--radius mt-4" href="<?php echo esc_url( $settings['btn_link']['url'] );?>">
                            <span class="btn__text">
                                <?php echo wp_kses( $settings['btn_title'], $allowed_tags );?>
                            </span>
                        </a>
                        <?php endif; ?>
                    </div>
