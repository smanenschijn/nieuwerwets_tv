...
class About_Us extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'About Us', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'about_us',
			[
				'label' => esc_html__( 'About Us', 'unico' ),
			]
		);
		$this->add_control(
			'title',
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <p class="lead-i"><?php echo wp_kses( $settings['text1'], $allowed_tags );?></p>
                        <?php if($settings['btn_link']['url']): ?>
                        <a href="<?php echo esc_url( $settings['btn_link']['url'] );?>" class="read-more"><?php echo wp_kses( $settings['btn_title'], $allowed_tags );?><i class="ti-arrow-right"></i></a>
                        <?php endif; ?>
                    </div>
