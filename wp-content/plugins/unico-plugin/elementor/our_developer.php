 ...
 * @since 1.0.0
 */
class Our_Developer extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Developer', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_developer',
			[
				'label' => esc_html__( 'Our Developer', 'unico' ),
			]
		);
		$this->add_control(
			'feature_image',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Hire Our Team', 'unico' ),
			]
		);
		$this->add_control(
			'btn_link',
            ...
            <div class="container-fluid p-0">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 p-0">
                        <div class="image-block-content bg-inverse">
