...
class Banner_V1 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Banner V1', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'banner_v1',
			[
				'label' => esc_html__( 'Banner V1', 'unico' ),
			]
		);
		$this->add_control(
			'bg_image',
                    ...
                    <div class="col col-lg-8 col-md-9 col-sm-12">
                        <div class="content light">
                            ...
                            <div class="btn-wrap mt-4">
                                <?php if($settings['btn_link']['url']): ?><a href="<?php echo esc_url( $settings['btn_link']['url'] );?>" class="btn btn-info btn-rounded btn-lg"><?php echo wp_kses( $settings['btn_title'], $allowed_tags );?></a><?php endif; ?>
