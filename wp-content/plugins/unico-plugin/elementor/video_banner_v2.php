 ...
 * @since 1.0.0
 */
class Video_Banner_V2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Video Banner V2', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'video_banner_v2',
			[
				'label' => esc_html__( 'Video Banner V2', 'unico' ),
			]
		);
		$this->add_control(
			'bg_image_v1',
	...
	protected function render() {
        ...
        <!-- ============================ Banner Video Start ================================== -->
        <section class="cover height-100 hero imagebg" data-overlay="6">
            ...
            <div class="container pos-vertical-center">
                <div class="row align-items-center">
                    <div class="col-md-6 col-lg-6">
                        ...
                        <p class="mb-5"><?php echo wp_kses( $settings['text'], $allowed_tags );?></p>
                        <?php if($settings['btn_link']['url']): ?>
                        <div class="btn-wrap">
                            <a href="<?php echo esc_url( $settings['btn_link']['url'] );?>" class="btn-lg btn-light btn-rounded"><?php echo wp_kses( $settings['btn_title'], $allowed_tags );?></a>
                        </div>
                        <?php endif; ?>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <div class="imagebg height-60 border--radius border--round box-shadow" data-overlay="3">
                            ...
                            <div class="bg-img-holder" style="background: url(<?php echo esc_url(wp_get_attachment_url($settings['video_image']['id']));?>); opacity: 1;">
                                <img alt="<?php esc_attr_e('Awesome Image', 'unico'); ?>" src="<?php echo esc_url(wp_get_attachment_url($settings['video_image']['id']));?>">
                            </div>
                            <?php endif; ?>
