 ...
 * @since 1.0.0
 */
class Advance_Features_V2 extends Widget_Base {
	...
	public function get_name() {
		return 'unico_advance_features_v2';
	}
	...
	public function get_title() {
		return esc_html__( 'Advance Features V2', 'unico' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'advance_features_v2',
			[
				'label' => esc_html__( 'Advance Features V2', 'unico' ),
			]
		);
		$this->add_control(
			'title',
	...
	protected function render() {
		...
		<?php while ( $query->have_posts() ) : $query->the_post();
			...
			?>
			<?php if( ($count == 1)):
				$left_arr[get_the_id()] = ' <div class="veticle-features mb-4">
												<div class="veticle-features-item">
													<div class="veticle-large-features-box"><i class="'.(str_replace( "icon ",  "", get_post_meta(get_the_id(), 'service_icon', true ))).'"></i></div>
													<div class="veticle-features-content">
														<h4>'.get_the_title(get_the_id()).'</h4>
														<p>'.unico_trim(get_the_content(), $settings['text_limit']).'</p>
													</div>
												</div>
											</div>';
			?>
			<?php else:
				$right_arr[get_the_id()] = ' <div class="veticle-features mb-4">
												<div class="veticle-features-item">
													<div class="veticle-large-features-box"><i class="'.(str_replace( "icon ",  "", get_post_meta(get_the_id(), 'service_icon', true ))).'"></i></div>
													<div class="veticle-features-content">
														<h4>'.get_the_title(get_the_id()).'</h4>
