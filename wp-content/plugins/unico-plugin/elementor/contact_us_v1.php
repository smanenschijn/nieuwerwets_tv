...
class Contact_Us_V1 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Contact Us V1', 'unico' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'contact_us_v1',
            [
                'label' => esc_html__( 'Contact Us V1', 'unico' ),
            ]
        );
		$this->add_control(
              'info', 
			  	[
            		...
            		'default' => 
						[
                			['title' => esc_html__('Virasat Limited', 'unico')],
                			['title' => esc_html__('Head Offices', 'unico')],
							['title' => esc_html__('Emails', 'unico')],
							['title' => esc_html__('Calls', 'unico')],
            			],
            		'fields' => 
						[
                			[
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="contact-form">
                            <?php echo do_shortcode($settings[contact_form_v1])?>
                        </div>
                    </div>
