...
use UNICO\Includes\Classes\Header_Enqueue;
use UNICO\Includes\Classes\Options;
...
class Base {
	...
	public static function instance() {
		...
		if ( isset( $GLOBALS['unico_base'] ) ) {
			return $GLOBALS['unico_base'];
		}
	...
	function option( $key = '' ) {
		...
		$options = (array) get_theme_mod( 'unico' . '_options-mods' );

		$dn = unico_dot( $options );
