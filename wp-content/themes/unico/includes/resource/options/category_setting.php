...
return  array(
    'title'      => esc_html__( 'Category Page Settings', 'unico' ),
    'id'         => 'category_setting',
    'desc'       => '', 
    'subsection' => true,
    'fields'     => array(
	    array(
		    ...
		    'type'    => 'button_set',
		    'title'   => esc_html__( 'Category Source Type', 'unico' ),
		    'options' => array(
	    ...
	    array(
		    ...
		    'type'     => 'section',
		    'title'    => esc_html__( 'Category Default', 'unico' ),
		    'indent'   => true,
	    ...
	    array(
		    ...
		    'default'  => array(
			    'url' => UNICO_URI . 'assets/images/resources/breadcrumb-bg.jpg',
		    ),
		    'required' => array( 'category_page_banner', '=', true ),
	    ),
