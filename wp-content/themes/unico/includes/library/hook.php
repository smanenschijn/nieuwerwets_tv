 ...
 */
//unico_load_default_hooks
function unico_load_default_hooks() {

	$config = unico_WSH()->config( 'default' );
...
/**
 * [unico_main_header_area description]
 *
 * @return [type] [description]
 */

//unico_main_header_area
function unico_main_header_area() {
	...
	//need to change
	if ( $header == 'header_v1' ) {
		unico_template_load( 'templates/header/default-header.php' );
	} elseif ( $header == 'header_v2' ) {
		unico_template_load( 'templates/header/header_v2.php' );
	} elseif ( $header == 'header_v3' ) {
		unico_template_load( 'templates/header/header_v3.php' );
	} elseif ( $header == 'header_v4' ) {
		unico_template_load( 'templates/header/header_v4.php' );
	} elseif ( $header == 'header_v5' ) {
		unico_template_load( 'templates/header/header_v5.php' );
	} elseif ( $header == 'header_v6' ) {
		unico_template_load( 'templates/header/header_v6.php' );
	} else {
		unico_template_load( 'templates/header/header_v2.php' );
	}
}
...
/**
 * [unico_main_footer_area description]
 *
 * @return [type] [description]
 */
//unico_main_footer_area
function unico_main_footer_area() {
	...
	//need to change
	if ( $footer == 'footer_v1' ) {
		unico_template_load( 'templates/footer/default-footer.php' );
	} elseif ( $footer == 'footer_v2' ) {
		unico_template_load( 'templates/footer/footer_v2.php' );
	} elseif ( $footer == 'footer_v3' ) {
		unico_template_load( 'templates/footer/footer_v3.php' );
	} elseif ( $footer == 'footer_v4' ) {
		unico_template_load( 'templates/footer/footer_v4.php' );
	} elseif ( $footer == 'footer_v5' ) {
		unico_template_load( 'templates/footer/footer_v5.php' );
	} else {
		unico_template_load( 'templates/footer/default-footer.php' );
	}
}
...
/**
 * [unico_sidebar description]
 *
 * @return [type] [description]
 */
//unico_sidebar
function unico_sidebar( $data ) {

	unico_template_load( 'templates/sidebar.php', compact( 'data' ) );
}

/**
 * [unico_banner description]
 *
 * @return [type] [description]
 */
//unico_banner
function unico_banner( $data ) {

	unico_template_load( 'templates/banner/banner.php', compact( 'data' ) );
