...
get_header();
global $wp_query;
$data  = \UNICO\Includes\Classes\Common::instance()->data( 'search' )->get();
                ...
                <div class="content-side <?php echo esc_attr( $class ); ?>">
                	<div class="blog-news big-detail-wrap">
                        ...
                        <div class="search-notfound">
                            <p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'unico' ); ?></p>
                            <div class="sidebar ml-0">
                                <div class="sidebar default-sidebar ml-0">
                                    <?php get_search_form() ?>
                                </div>
                            </div>
                        </div>
