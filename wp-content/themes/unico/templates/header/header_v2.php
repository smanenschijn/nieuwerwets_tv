                ...
                <div class="nav-menus-wrapper" style="transition-property: none;">
                    ...
                    <ul class="nav-menu nav-menu-social align-to-right">
                        <li class="add-listing">
                            <a href="<?php echo esc_url($options->get('btn_link_v2'), $allowed_html);?>" data-toggle="modal" data-target="#getstarted"><?php echo wp_kses($options->get('btn_title_v2'), $allowed_html);?></a>
                        </li>
                    </ul>
                    <?php endif; ?>
                </div>
